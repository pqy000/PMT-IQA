...
def objective(trial):
    ...
    folder_path = {
        'live': main_path + '/image_data2/LIVE/',  #
        'csiq': main_path + '/image_data2/CSIQ/',  #
    ...
    config.batch_size = trial.suggest_int("batch_size", 9, 13, step=1)
    config.lambda1 = trial.suggest_float("lambda1", 0.9, 2.0, log=True)
